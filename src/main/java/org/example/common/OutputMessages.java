...
public class OutputMessages {
    ...
    public static final String COMPANY_NAME_AND_REVENUE = "Company: {0} | Revenue: ${1}";
    public static final String COMPANY_REVENUE_FOR_PERIOD = "Company ID #{} | revenue for the period: ${1}";
